                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    >
                                        ...
                                        <input type="submit" value={id ? 'Edit Task':'Create Task'}  className='text-sm bg-sky-600 hover:bg-sky-700 w-full p-3 text-white uppercase font-bold cursos-pointer transition-colors rounded '/>
                                    </form>
                                </div>
                            </div>
                        </div>
